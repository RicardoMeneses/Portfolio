...
const Project: React.FC<Props> = ({ project }) => {
  return (
    ...
    >
      <div className='h-12 w-full bg-[#c6c4c4] rounded-t-2xl flex items-center p-5 gap-2 md:gap-3'>
      ...
      <img src={project.img} className='h-full rounded-b-2xl' alt={project.title} />
